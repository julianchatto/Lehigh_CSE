...
const string REQ_KVT = "TOP_";

/// Response code to indicate a download quota violation
const string RES_ERR_QUOTA_DOWN = "ERR_QUOTA_DOWN";

/// Response code to indicate an upload quota violation
const string RES_ERR_QUOTA_UP = "ERR_QUOTA_UP";

/// Response code to indicate a request count violation
const string RES_ERR_QUOTA_REQ = "ERR_QUOTA_REQ";
