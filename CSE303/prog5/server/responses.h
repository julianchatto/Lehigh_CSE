...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvf(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx, const string &u, const string &p, const vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kmr(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx, const string &u, const string &p, const vector<uint8_t> &req);
