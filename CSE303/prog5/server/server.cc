...
int main(int argc, char **argv) {
	...
	Gatekeeper *storage = gatekeeper_factory(args->datafile, args->num_buckets, args->quota_up, args->quota_down, args->quota_req, args->quota_interval, args->top_size, args->admin_name);
