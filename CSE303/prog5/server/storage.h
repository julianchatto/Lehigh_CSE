...
public:
	...
	///
	/// @return A result tuple, as described above
	virtual result_t kv_insert(const string &user, const string &pass, const string &key, const vector<uint8_t> &val, function<void()> on_success) = 0;
	...
	///
	/// @return A result tuple, as described above
	virtual result_t kv_get(const string &user, const string &pass, const string &key, function<void(size_t)> on_success) = 0;
	...
	///
	/// @return A result tuple, as described above
	virtual result_t kv_delete(const string &user, const string &pass, const string &key, function<void()> on_success) = 0;
	...
	virtual result_t kv_upsert(const string &user, const string &pass, const string &key, const vector<uint8_t> &val, function<void()>) = 0;
	...
	///
	/// @return A result tuple, as described above
	virtual result_t kv_all(const string &user, const string &pass, function<void()> on_success) = 0;
	...
	///
	/// @return A result tuple, as described above
	virtual result_t register_mr(const string &user, const string &pass, const string &mrname, const vector<uint8_t> &so) = 0;
	...
	///
	/// @return A result tuple, as described above
	virtual result_t invoke_mr(const string &user_name, const string &pass, const string &mrname) = 0;
...
Storage *storage_factory(const string &fname, size_t buckets, const string &admin);