...
bool aes_crypt(EVP_CIPHER_CTX *ctx, FILE *in, FILE *out) {
	...
	// Set up a buffer where AES puts encrypted bits.  Since the last block is
 ...
 */
EVP_CIPHER_CTX *get_aes_context(string keyfile, bool encrypt) {
 ...
 */
void generate_aes_key_file(string keyfile) {
