...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_all(int sd, Storage *storage, EVP_CIPHER_CTX *ctx, const string &u, const string &p, const vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_reg(int sd, Storage *storage, EVP_CIPHER_CTX *ctx, const string &u, const string &p, const vector<uint8_t> &req);
...
bool handle_bye(int sd, Storage *storage, EVP_CIPHER_CTX *ctx, const string &u, const string &p, const vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_sav(int sd, Storage *storage, EVP_CIPHER_CTX *ctx, const string &u, const string &p, const vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kva(int sd, Storage *storage, EVP_CIPHER_CTX *ctx, const string &u, const string &p, const vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvi(int sd, Storage *storage, EVP_CIPHER_CTX *ctx, const string &u, const string &p, const vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvu(int sd, Storage *storage, EVP_CIPHER_CTX *ctx, const string &u, const string &p, const vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvg(int sd, Storage *storage, EVP_CIPHER_CTX *ctx, const string &u, const string &p, const vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvd(int sd, Storage *storage, EVP_CIPHER_CTX *ctx, const string &u, const string &p, const vector<uint8_t> &req);