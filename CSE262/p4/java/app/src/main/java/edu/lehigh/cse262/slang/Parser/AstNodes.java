...
public class AstNodes {
    ...
    public static abstract class AstNode {
        /**
         * `execute()` implements a visitor pattern, enabling a top-down,
         * left-right recursive descent walk through an AST to produce a Datum.
         *
         * @param visitor The visitor object
         *
         * @return A value that was produced by the visitor
         */
        public abstract Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError;
    }
    ...
    public static class Cons extends Datum {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitCons(car, cdr, this);
        }
    }
    ...
    public static class Vec extends Datum {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitVec(items, this);
        }
    }
    ...
    public static class Char extends Datum {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitChar(this.val, this);
        }
    }
    ...
    public static class EmptyCons extends Datum {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitEmptyCons(this);
        }
    }
    ...
    public static class Dbl extends Datum {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitDbl(val, this);
        }
    }
    ...
    public static class Int extends Datum {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitInt(val, this);
        }
    }
    ...
    public static class Str extends Datum {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitStr(val, this);
        }
    }
    ...
    public static class Symbol extends Datum {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitSymbol(name, this);
        }
    }
    ...
    public static class And extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitAnd(expressions);
        }
    }
    ...
    public static class Call extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitCall(expressions);
        }
    }
    ...
    public static class Begin extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitBegin(expressions);
        }
    }
    ...
    public static class Cond extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitCond(conditions);
        }
    }
    ...
    public static class DefineVar extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitDefineVar(identifier, expression);
        }
    }
    ...
    public static class DefineFunc extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitDefineFunc(ids, body);
        }
    }
    ...
    public static class Identifier extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitIdentifier(name);
        }
    }
    ...
    public static class If extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitIf(test, ifTrue, ifFalse);
        }
    }
    ...
    public static class LambdaDef extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitLambdaDef(formals, exprs, this);
        }
    }
    ...
    public static class Or extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitOr(expressions);
        }
    }
    ...
    public static class Quote extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitQuote(datum);
        }
    }
    ...
    public static class Set extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitSet(id, expr);
        }
    }
    ...
    public static class Tick extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitTick(datum);
        }
    }
    ...
    public static class Let extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitLet(vars, body);
        }
    }
    ...
    public static class Apply extends AstNode {
        ...
        @Override
        public Values.Value interpret(INodeVisitor<Values.Value> visitor) throws INodeVisitorError {
            return visitor.visitApply(func, args);
        }
    }
}
